...
@section('BarberoContenido')
    ...
    <div class="servicio-create">
        <header class="page-header">
            ...
            <p>Define el nombre y precio del servicio que ofrecerás</p>
        </header>

        <div class="form-card">
            <form action="{{ route('barbero.servicios.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="form-grid">
                    ...
                    <div class="form-group full">
                        ...
                        <div class="image-upload" id="dropZone">
                            ...
                            <p>📷 Arrastra o haz clic para subir imagen (JPG/PNG/WebP, máx 2MB)</p>
