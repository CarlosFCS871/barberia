...
@section('BarberoContenido')
    ...
    <div class="horario-form">
        <header class="page-header">
            <h1>🕐 Nuevo Horario</h1>
            <p>Define tus días y franjas de atención para recibir citas</p>
        </header>
        <form class="form-card" action="{{ route('barbero.horarios.store') }}" method="POST">
            @csrf
            <div class="form-grid">
                ...
                <div class="form-group">
                    <input type="time" name="hora_inicio" class="form-input time-input" placeholder="00:00" required>
                ...
                <div class="form-group">
                    <input type="time" name="hora_fin" class="form-input time-input" placeholder="00:00" required>
